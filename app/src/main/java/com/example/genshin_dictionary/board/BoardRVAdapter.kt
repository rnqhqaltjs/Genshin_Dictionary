...
class BoardRVAdapter(val context: Context,val items:MutableList<BoardModel>,val keys:MutableList<String>)
    : RecyclerView.Adapter<BoardRVAdapter.Viewholder>(){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Viewholder {
        val binding = BoardRvItemBinding.inflate(LayoutInflater.from(parent.context),parent,false)
